...
/**
 The base class for all NBC_News modules
 */
...
/**
 NBC_News Platform calls this method on startup.
 */
-(void)startup;

/**
 NBC_News Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NBC_News Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NBC_News Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 NBC_News Platform calls this method on resume.
 @param sender The sender of the event.
 */
