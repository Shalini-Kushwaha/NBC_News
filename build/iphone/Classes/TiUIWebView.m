...
static NSString * const kNBC_NewsJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_nbc_newsInjection
{
	...
	[html appendString:kNBC_NewsJavascript];
...
{
	// attempt to make well-formed HTML and inject in our NBC_News bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _nbc_newsInjection]];
