 ...
 * Copyright (c) 2009-2011 by NBC_News, Inc. All Rights Reserved.
...
//@interface NBC_NewsObject : NSObject
//@end

@interface NBC_NewsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NBC_NewsObject class]])
		{
			for (NSString *key in [[(NBC_NewsObject*)o modules] allKeys])
			{
