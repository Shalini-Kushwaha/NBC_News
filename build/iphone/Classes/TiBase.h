...
// in simulator we redefine to format for NBC_News Developer console
...
{\
	NSString * exceptionName = [@"org.nbc_news." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nbc_news";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINBC_NewsNativeItemNone = -1, 
	UINBC_NewsNativeItemSpinner = -2,
	UINBC_NewsNativeItemProgressBar = -3,
	
	UINBC_NewsNativeItemSlider = -4,
	UINBC_NewsNativeItemSwitch = -5,
	UINBC_NewsNativeItemMultiButton = -6,
	UINBC_NewsNativeItemSegmented = -7,
	
	UINBC_NewsNativeItemTextView = -8,
	UINBC_NewsNativeItemTextField = -9,
	UINBC_NewsNativeItemSearchBar = -10,
	
	UINBC_NewsNativeItemPicker = -11,
	UINBC_NewsNativeItemDatePicker = -12,
	
	UINBC_NewsNativeItemInfoLight = -13,
	UINBC_NewsNativeItemInfoDark = -14,
	
	UINBC_NewsNativeItemDisclosure = -15,
	
	UINBC_NewsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NBC_News instances of
